          ...
          <div className='col-lg-3'>
            ...
            <div className='border mt-3 p-3 rounded shadow'>
              ...
              <div className='d-grid'>
                  <button onClick={handleCart} className='btn btn-dark mt-5 rounded'>Check Out</button>
              </div>
            </div>
          </div>
        </div>
        :<div style={{height:'60vh'}} className='w-100 d-flex flex-column justify-content-center align-items-center'>
        <img height={'250'} src="https://cdn.dribbble.com/users/1244867/screenshots/4346888/media/8c1099726d0428fed0e0a2f0a5430b37.jpg?resize=768x576&vertical=center" />
